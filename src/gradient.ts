...
export const api = {
  ...
  doGradient: function(bg: any, width: any, height: any, ctx: any) {
...
function analizeGrad(string: any) {
...
function radialEffect(width: any, height: any, bg: any, ctx: any) {
...
function analizeLinear(bg: any, width: any, height: any) {
...
function linearEffect(width: any, height: any, bg: any, ctx: any) {
